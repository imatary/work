...
namespace ReportsMaster
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            using (var mutex = new Mutex(true, "Brother Reports System", out ownmutex))
            {
        ...
        {
            string connectionString = ConfigurationManager.ConnectionStrings["MasterDbContext"].ConnectionString; ;
