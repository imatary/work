...
namespace OverTime.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var departments = await _userDepartmentsService.GetUserDepartmentsAsync(User.Identity.GetUserId());
            ViewBag.UserDepartments = departments.Select(u => u.Name).ToList();
            return View(model);
        }
