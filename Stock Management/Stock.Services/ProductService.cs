...
namespace Stock.Services
{
    public class ProductService
    {
        ...
        {
            return GetProducts().FirstOrDefault(u => u.ProductID == productId);
        }
        ...
        {
            return GetProducts().FirstOrDefault(u => u.ProductName == productName);
        }
        ...
        {
            return GetProducts().FirstOrDefault(u => u.Barcode == barcode);
        }
