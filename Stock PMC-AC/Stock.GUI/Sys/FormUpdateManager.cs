...
{
    public partial class FormUpdateManager : XtraForm
    {
        private readonly string _employeeId;
        private readonly EmployeeService _employeeService;
        private readonly DepartmentService _departmentService;
        private readonly LogService _logService;
        public FormUpdateManager(string employeeId)
        {
            InitializeComponent();
        ...
        private void FormUpdateManager_FormClosing(object sender, FormClosingEventArgs e)
        {
            Close();
        }
