...
namespace Lib.Core
{
    public static class GetValueWindowText
    {
        ...
        public static StringBuilder GetAllTextFromWindowByTitleStringBuilder(string windowTitle)
        {
