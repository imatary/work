...
namespace GetWindowTextExample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var allText = GetAllTextFromWindowByTitle("TeamViewer");
        ...
        {
            var allText = GetAllTextFromWindowByTitle("TeamViewer");
            var tmp = allText.Split(separator: new[] { "Remote Control" }, count: 4, options: StringSplitOptions.None);
            var result = tmp[1].Split(separator: new[] { "Remote controlFile" }, count: 4, options: StringSplitOptions.None);
