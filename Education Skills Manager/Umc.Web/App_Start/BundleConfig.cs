...
namespace Umc.Web
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            RegisterEmployee(bundles);

            RegisterSubject(bundles);
        ...
        private static void RegisterSubject(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Subject/menu").Include(
                "~/Scripts/Subject/Subject-menu.js"));
        }
        private static void RegisterEmployee(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Employee/menu").Include(
                "~/Scripts/Employee/Employee-menu.js"));
        }
