...
namespace UMCWorkManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult _Upload(IEnumerable<HttpPostedFileBase> files)
        {
            ...
            if (file == null || !ImageUpload.IsImage(file))
            ...
            var webPath = ImageUpload.GetTempSavedFilePath(file);
        ...
        public ActionResult Save(string t, string l, string h, string w, string fileName)
        {
            try
            {
                ...
                var fn = Path.Combine(Server.MapPath(ImageUpload.MapTempFolder), Path.GetFileName(fileName));
                // ...get image and resize it, ...
                var img = new WebImage(fn);
                img.Resize(width, height);
                // ... crop the part the user selected, ...
                img.Crop(top, left, img.Height - top - ImageUpload.AvatarStoredHeight, img.Width - left - ImageUpload.AvatarStoredWidth);
                // ... delete the temporary file,...
                System.IO.File.Delete(fn);
                // ... and save the new one.
                var newFileName = Path.Combine(ImageUpload.AvatarPath, Path.GetFileName(fn));
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register([Bind(Exclude = "avatar")]RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
